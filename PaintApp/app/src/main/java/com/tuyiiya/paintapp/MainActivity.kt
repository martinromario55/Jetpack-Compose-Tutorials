...
import com.tuyiiya.paintapp.ui.theme.PaintAppTheme
...
fun PaintAppView() {
    ...
    Column(
        ...
        Row(
            ...
            BrushSizeSelector(brushSize, onSizeSelected = {selectedSize -> brushSize = selectedSize}, isEraser = isEraser, keepMode = {keepEraserMode -> isEraser = keepEraserMode})
